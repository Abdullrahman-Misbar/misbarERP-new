...
function SupplierIcon() {
  return (
    <>
      ...
      >
        <g clip-path="url(#clip0_2382_107209)">
          <path
          ...
          />
          <path
            d="M15 14V12C15 11.4696 14.7893 10.9609 14.4142 10.5858C14.0391 10.2107 13.5304 10 13 10H9M9 10L11 8M9 10L11 12"
            stroke="#3F51B5"
            stroke-width="2"
            stroke-linecap="round"
            stroke-linejoin="round"
