      ...
      <Route path="/" element={<Root />} errorElement={<ErrorPage />}>
        ...
        />
         ...
         <Route
          ...
          element={<PurchaseRepresentative title={t("Purchasing representatives")} />}
        />
        <Route
          path="/purchase/PurchaseRepresentative/add"
          element={<AddPurchaseRepresentative title={t("Add Purchasing representatives")} />}
        />
        <Route
          path="/purchase/PurchaseRepresentative/edit/:id"
          element={<EditPurchaseRepresentative title={t("Edit Purchasing representatives")} />}
        />
      </Route>
