...
export const deleteEndPoint = "api/PartnerGroups/deletePartnerGroup";
...
export const ApproveOrDisApproveEndPoint =
  "api/PartnerGroups/ApproveOrDisApprove";
export const newCodeEndpoint = "api/PartnerGroups/newCode";
export const MultiDeleteEndPoint = "api/PartnerGroups/MultiDeleteEndPoint";
